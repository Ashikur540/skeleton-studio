...
export function ExportShowcase() {
  return (
    <section
      ...
      id="export"
    >
      <div className="detail-aurora absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[720px] h-[520px] pointer-events-none z-0 opacity-90" />
      ...
      <div className="max-w-[1240px] mx-auto px-8 relative z-[1]">
        <div className="text-center mb-16">
          ...
          <h2 className="gradient-heading-sm text-[48px] font-semibold leading-[1.08] tracking-[-0.028em] m-0">
            Export React + Tailwind CSS skeleton code.
          </h2>
          <p className="mt-[18px] mx-auto text-[18px] leading-relaxed text-muted-foreground max-w-[620px]">
            Copy production-ready skeleton loader code — React with Tailwind CSS
            or plain HTML with Tailwind. Syntax-highlighted, validated, ready to
          ...
          <div className="export-modal-card aurora-card relative rounded-2xl overflow-hidden isolate">
            ...
            <div className="relative z-[2] flex items-center justify-between px-4 py-3 bg-[rgba(8,15,12,0.4)] border-b border-primary/10">
              <div className="flex items-center gap-3 flex-wrap">
                <div className="inline-flex p-0.5 rounded-[7px] bg-card border border-white/[0.06]">
                  <button className="h-[26px] px-3.5 rounded-md text-[12.5px] text-foreground whitespace-nowrap bg-muted">
                    React · Tailwind
                  </button>
                  <button className="h-[26px] px-3.5 rounded-md text-[12.5px] text-muted-foreground whitespace-nowrap">
                    HTML · Tailwind
                  </button>
                </div>
                <span className="font-mono text-[11.5px] text-foreground/30">
            ...
            <div className="grid grid-cols-[1fr_240px] max-md:grid-cols-1">
              <div className="relative z-[2] p-[18px_22px] font-mono text-xs leading-[1.7] whitespace-pre overflow-hidden bg-background border-r border-white/[0.04] max-md:border-r-0">
                ...
                <span className="tok-fn">ProfileCardSkeleton</span> = () =&gt;{" "}
                {"{"}
                {"\n"}
                {"  "}
                ...
                <span className="tok-tag">div</span>{" "}
                <span className="tok-attr">className</span>=
                <span className="tok-str">&quot;flex gap-4&quot;</span>
                <span className="tok-punct">&gt;</span>
                {"\n"}
                {"        "}
                <span className="tok-punct">&lt;</span>
                ...
                <span className="tok-tag">div</span>{" "}
                <span className="tok-attr">className</span>=
                <span className="tok-str">&quot;flex-1 space-y-2&quot;</span>
                <span className="tok-punct">&gt;</span>
                {"\n"}
                {"          "}
                <span className="tok-punct">&lt;</span>
                <span className="tok-tag">div</span>{" "}
                <span className="tok-attr">className</span>=
                <span className="tok-str">&quot;h-4 w-3/5 ...&quot;</span>{" "}
                <span className="tok-punct">/&gt;</span>
                {"\n"}
                {"        "}
                <span className="tok-punct">&lt;/</span>
              ...
              <div className="relative z-[2] p-[18px] flex flex-col gap-3.5">
                <h5 className="m-0 text-[11px] tracking-[0.1em] uppercase text-muted-foreground font-semibold">
                  Summary
                </h5>
                {[
                  ["Nodes", "12"],
                  ...
                  <div
                    key={label as string}
                    className="flex justify-between items-center gap-3 text-[12.5px] text-muted-foreground whitespace-nowrap"
                  >
                    <span>{label}</span>{" "}
                ...
                {[
                  ...
                  <div
                    key={label as string}
                    className="flex items-center justify-between gap-3 text-[12.5px] text-muted-foreground whitespace-nowrap"
                  >
                    <span>{label}</span>
                    <span
                      className={`toggle-thumb relative w-7 h-4 rounded-full ${on ? "toggle-thumb-on bg-primary" : "bg-white/[0.14]"}`}
                    />
                  </div>
                ))}
              </div>
            ...
            <div className="relative z-[2] flex items-center justify-between px-4 py-3 bg-[rgba(8,15,12,0.4)] border-t border-primary/10 max-md:flex-col max-md:gap-2 max-md:items-start">
              ...
              <div className="flex gap-2 items-center">
                <button className="h-8 px-3 text-[13px] font-medium rounded-lg border border-white/[0.06] btn-ghost bg-transparent!">
                  Cancel
                </button>
                <button
                  className="btn-primary relative h-8 px-3 inline-flex items-center gap-2 text-[13px] font-semibold rounded-lg"
                  style={{
                    background:
                      "linear-gradient(180deg, #14d39d 0%, #0fb87f 100%)",
                    color: "#03291e",
